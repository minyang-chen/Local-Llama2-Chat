...
# To create a public link, set `share=True` in `launch(share=True)`.
# demo.queue(max_size=20).launch(ssl_verify=False,debug=False, share=True,server_name="0.0.0.0", ssl_certfile="cert.pem",ssl_keyfile="key.pem")
demo.queue(max_size=20).launch(ssl_verify=False,debug=False, share=True,server_name="0.0.0.0")
